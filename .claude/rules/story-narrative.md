...
6. **对话口语化**（红线级约束）：角色对话和内心独白必须说人话，禁止书面腔。第三人称叙述（场景/打斗/人物描写）不受此限，越文学越好。详见 [story-colloquial.md](story-colloquial.md)。
...
8. **对话三功能检验**：每段对话删掉后检查——情节还能推进吗？期待感还在吗？情绪还到位吗？三项全否 = 水字数，删。
...
正文第15章写到：密室中的古镜映出一个陌生人的脸。
追踪/伏笔.md 中无任何记录。
写作到第40章时，作者忘记这个悬念，或给出与后续情节矛盾的解释。
```
悬念没有文档记录，容易遗忘或自相矛盾。
